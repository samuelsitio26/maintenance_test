	...
	async function fetchRentals() {
		try {
			...
			const response = await fetch(
				'https://directus.eltamaprimaindo.com/items/rentals?fields=*,barang_id.id,barang_id.Nama,barang_id.StokIn,barang_id.parent_category.parent_category,barang_id.sub_category.nama_sub&filter[barang_id][parent_category][parent_category][_eq]=SPAREPART',
				{
					headers: {
...
>
	...
	<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
		<div>
			<h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Monitoring Sparepart</h1>
